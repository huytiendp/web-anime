        ...
        <div class="header">
            <div class="container">
                ...
                <div class="widget_user_header">
                    <a class="button-login" rel="nofollow" href="{{ route('login') }}">
                </div>
            </div>
            ...
            <div class="block-wrapper page-single " itemscope="" itemtype="https://schema.org/Movie">
                <div class="movie-info">
                    <div class="block-movie-info">
                        <div class="row">
                            <div class="col-6 movie-detail">
                                <h1 class="movie-title"><span class="title-1" itemprop="name">KAGE NO JITSURYOKUSHA NI NARITAKUTE!</span><span class="title-2" itemprop="name">Shadow Garden | Ta Muốn Trở Thành Chúa Tể Bóng Tối</span><span class="title-year"> (2022)</span></h1>
                                <div class="movie-meta-info">
                                    <dl class="movie-dl">
                                        <dt class="movie-dt">Trạng thái: </dt>
                                        <dd class="movie-dd imdb">20/20</dd><br>
                                        <dt class="movie-dt">Thể loại: </dt>
                                        <dd class="movie-dd dd-cat"><a href="?">Hành động</a>, <a href="?">Hài hước</a>, <a href="?">Fantasy</a>, <a href="?">Xuyên Không - Chuyển Kiếp</a></dd><br>
                                        ...
                                        <dd class="movie-dd"><a href="?"> Mùa Thu Năm 2022</a></dd><br>
                                        <dt class="movie-dt">Năm: </dt>
                                        <dd class="movie-dd"><a href="/tim-nang-cao/?status=&amp;season=&amp;year=2024&amp;sort=popular">2022</a>
                                        </dd><br>
                                ...
                                <div class="box-rating">
                                    ...
                                    <div class="content" id="film-content" itemscope="" itemtype="http://schema.org/Review" itemprop="review">
                                        <div class="news-article">
                                            <p></p>
                                            <p>Những anh hùng vĩ đại và những nhân vật phản diện độc ác là kiểu nhân vật mà mọi người ao ước - nhưng không phải Cid Kagenou. Anh ta khao khát trở thành kẻ chủ mưu thực sự đằng sau tất cả, giật dây và để mưu đồ của anh ta điều khiển toàn bộ câu chuyện. Trong kiếp trước ở Nhật Bản ngày nay, anh đã không thể đạt được mục tiêu của mình. Nhưng bây giờ, được tái sinh vào một thế giới của phép thuật, anh ta sẽ thể hiện bản chất thực sự của cái bóng! Khi Cid giả vờ chỉ là một nhân vật đám đông bình thường khác, anh ta tuyển mộ các thành viên vào tổ chức (giả) của mình Shadow Garden, nhằm mục đích tiêu diệt giáo phái bí ẩn ẩn nấp trong bóng tối. Với rất nhiều ad-libs, Cid lãnh đạo tổ chức (giả) của mình chống lại Giáo phái Diabolos xấu xa (nhưng thật đáng ngạc nhiên). [Viết bởi MAL Rewrite]</p>
                                            <p></p>
                                        </div>
                            ...
                            <div class="col-6 movie-image">
                                <div class="movie-l-img"><img itemprop="image" alt="" src="https://imgur-com.cdn.ampproject.org/i/imgur.com/mJG2AJV.jpg" id="style-lOE6n" class="style-lOE6n">
                    ...
                    <blockquote class="block-movie-content">
                        <div>
                        <b>Xem phim tại: </b><div class="block2 servers">
                            <div>
                                <p></p>
                                <h4>Anime47: </h4>
                                <p></p>
                                <a href="https://anime47.cam/xem-phim-kage-no-jitsuryokusha-ni-naritakute-ep-01/191712.html"><div class="logo-anime47"></div></a>
                            ...
                            <div>
                                ...
                                <h4>Animehay:</h4>
                                <p></p>
                                <a href="https://animehay.ink/xem-phim/kage-no-jitsuryokusha-ni-naritakute-tap-1-54054.html"><div class="chinh-logo">        
                            ...
                            <div>
                                ...
                                <a href="https://vuighe4.com/kage-no-jitsuryokusha-ni-naritakute/tap-1"><div class="chinh-logo">

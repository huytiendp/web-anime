                    ...
                    <div class="block-movie-info">
                        <div class="row">
                            <div class="col-6 movie-detail">
                                <h1 class="movie-title"><span class="title-1" itemprop="name">CÔNG CUỘC TÁI THIẾT VƯƠNG QUỐC CỦA ANH HÙNG CHỦ NGHĨA HIỆN THỰC</span><span class="title-2" itemprop="name">Genjitsu Shugi Yuusha no Oukoku Saikenki - Re:Construction the Elfrieden Kingdom Tales of Realistic Brave - A Realist Hero's Kingdom Restoration Chronicle</span><span class="title-year"> (2021)</span></h1>
                                <div class="movie-meta-info">
                                    <dl class="movie-dl">
                                        <dt class="movie-dt">Trạng thái: </dt>
                                        <dd class="movie-dd imdb">13/13</dd><br>
                                        <dt class="movie-dt">Thể loại: </dt>
                                        <dd class="movie-dd dd-cat"><a href="?">Hành động</a>, <a href="?">Romance</a>, <a href="?">Fantasy</a></dd><br>
                                        ...
                                        <dd class="movie-dd"><a href="?"> Mùa Hạ Năm 2021</a></dd><br>
                                ...
                                <div class="box-rating">
                                    ...
                                    <div class="content" id="film-content" itemscope="" itemtype="http://schema.org/Review" itemprop="review">
                                        <div class="news-article">
                                            <p></p>
                                            <p>Hỡi anh hùng! Khi Kazuya Souma bất ngờ bị chuyển đến một thế giới khác, anh ấy biết mọi người mong đợi một anh hùng. Nhưng ý tưởng về chủ nghĩa anh hùng của Souma thực tế hơn hầu hết — anh ấy muốn xây dựng lại nền kinh tế đang phát triển mạnh mẽ của vùng đất mới mà anh ấy đã tìm thấy! Được đính hôn với công chúa và đột ngột lên ngôi, người anh hùng hiện thực này phải tập hợp những người tài giỏi để giúp anh ta đưa đất nước trở lại bình thường — không phải thông qua chiến tranh hay phiêu lưu, mà bằng cải cách hành chính! (Nguồn: Seven Seas Entertainment)</p>
                                            <p></p>
                                        </div>
                            ...
                            <div class="col-6 movie-image">
                                <div class="movie-l-img"><img itemprop="image" alt="" src="https://imgur-com.cdn.ampproject.org/i/imgur.com/dYVKaNv.jpg" id="style-lOE6n" class="style-lOE6n">
                    ...
                    <blockquote class="block-movie-content">
                        ...
                        <b>Xem phim tại: <div class="block2 servers">
                            <div>
                                ...
                                <h4>Anime47: </h4>
                                <p></p>
                                <a href="https://anime47.cam/xem-phim-cong-cuoc-tai-thiet-vuong-quoc-cua-anh-hung-chu-nghia-hien-thuc-ep-01/176619.html"><div class="logo-anime47"></div></a>
                            ...
                            <div>
                                ...
                                <h4>Animehay:</h4>
                                <p></p>
                                <a href="https://animehay.ink/xem-phim/genjitsu-shugi-yuusha-no-oukoku-saikenki-tap-1-48336.html"><div class="chinh-logo">        
                            ...
                            <div>
                                ...
                                <a href="https://vuighe4.com/genjitsu-shugi-yuusha-no-oukoku-saikenki/tap-1"><div class="chinh-logo">
